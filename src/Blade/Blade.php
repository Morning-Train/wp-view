<?php
    ...
    class Blade
    {
         ...
         * Register a composer.
         *
         * @param string|array $key The name of the composer to register
         ...
         * @return ViewInterface The generated view
         */
        public static function first(array $views, $data = [], $mergeData = []): ViewInterface
        {
            return static::getInstance()->first($views, $data, $mergeData);
        }
